...
const Jobs = () => {
  return (
    ...
    <div className="flex flex-col gap-4">
      ...
      {JOBS.map(job => (
        <a key={job.name} className="p-4 mb-4 last-of-type:mb-0 hover:border border-light-border hover:bg-light-5/30 transition-colors hover:p-[15px] rounded-md" href={job.link}>
