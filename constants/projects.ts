export interface ISource {
    link: string;
    type: 'github' | 'codepen' | 'project' | undefined
}
...
export const PROJECTS: IProject[] = [
    {
        ...
        sources: [{link: 'https://github.com/JoshMontech/joshmontech.com-2024', type: 'github'}, {link: 'https://joshmontech.com', type: 'project'}],
    ...
    {
        name: 'Prog Logger',
        sources: [{link: 'https://github.com/JoshMontech/Prog-Logger', type: 'github'}, {link: 'https://prog-logger.vercel.app/static/102112c3-1b37-4eaf-935f-5433c3e51eb4', type: 'project'}],
    ...
    },
    {
        ...
        sources: [{link: 'https://codepen.io/jmontech/full/OJYdwJb', type: 'codepen'}],
    ...
    },
    {
        ...
        sources: [{link: 'https://github.com/JoshMontech/wedding-website', type: 'github'}, {link: 'https://bjmontgomery2025.com', type: 'project'}],
    ...
    },
    {
        ...
        sources: [{link: 'https://codepen.io/jmontech/pen/mdYmmyp', type: 'codepen'}],
    ...
    {
        name: 'Meteor Marker',
        sources: [{link: 'https://github.com/JoshMontech/brel-meteors', type: 'github'}, {link: 'https://brel-meteors.vercel.app', type: 'project'}],
    ...
    },
    {
        ...
        sources: [{link: 'https://github.com/JoshMontech/jmontech-next-template', type: 'github'}],
